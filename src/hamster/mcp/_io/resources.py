...
Reads resource markdown files from the ``hamster.mcp._core.resources``
...
from hamster.mcp._core.resources import GROUPS, ResourceEntry, parse_index
...
def load_group(group_name: str) -> list[ResourceEntry]:
    ...
    ``hamster.mcp._core.resources`` package.
    """
    group_dir = _resources.files("hamster.mcp._core.resources").joinpath(group_name)
